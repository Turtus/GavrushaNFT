...
/**
* Gavrusha the Cat NFT from https://developers.tron.network/docs/token-issuance
*/
...
contract GavrushaNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("Gavrusha", "GVR") {
